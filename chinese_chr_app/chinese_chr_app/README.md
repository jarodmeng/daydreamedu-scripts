...
Latest release: Add multi-period `每日练习统计` summaries on the 我的 page, with rolling `最近7天` / `最近1个月` / `最近1季度` plus `累计` totals, active-day counts, and category breakdowns.
