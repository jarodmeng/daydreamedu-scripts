                    ...
                    "content": [
                        {
                            ...
                            "text": (
                                ...
                                "\n"
                                "Words (词组) on these cards are often 2-character or 4-character words/idioms.\n"
                                "  - When a 4-character idiom or phrase is printed as one continuous unit (no separator), treat it as ONE word item.\n"
                                "  - NEVER split a 4-character idiom into two 2-character words.\n"
                                "  - EVERY word/phrase in the Words JSON array MUST contain the main Character at least once (in the whole string).\n"
                                "    - If the Character only appears when the phrase is kept whole (e.g. 来日方长, 秋收冬藏, 寒冬腊月), keep the whole idiom as a single word item.\n"
                                "  - Do NOT split an idiom and then drop parts: if the Character appears anywhere in a multi-character idiom on the card, output the WHOLE idiom as one item (e.g. 冬 → 秋收冬藏 and 寒冬腊月, not 冬藏 and 寒冬 alone).\n"
                                "\n"
                                "Example (Character 来, Index 0132): the correct Words list is:\n"
                                "  [\"来去\",\"回来\",\"过来\",\"来历\",\"来生\",\"来访\",\"来年\",\"来此\",\"来日方长\",\"人来人往\"]\n"
                                "You MUST NOT output split halves like \"来日\" + \"方长\" or \"人来\" + \"人往\".\n"
                                "\n"
                                ...
                                "  2. EVERY word/phrase in the Words (词组) field\n"
                                "\n"
                                "If the character does NOT appear in the Sentence or in EVERY Words item:\n"
                                "  - STOP IMMEDIATELY - This is a definite OCR/extraction error.\n"
                                "  - DO NOT OUTPUT the incorrect character or bad words.\n"
                                ...
                                "If your character doesn't appear in the sentence or in EVERY word/phrase, you have made an error - fix it before outputting.\n"
                                "\n"
