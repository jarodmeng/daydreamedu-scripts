...
TOOL_METADATA: dict[str, dict[str, Any]] = {
    ...
    "pdf_get_book_answer_mapping": {"description": "Get the answer-page mapping for one registered book unit file.", "tags": {"readonly", "groups", "relations", "books"}},
    "pdf_list_book_answer_mappings": {"description": "List registered book answer mappings with optional filters.", "tags": {"readonly", "groups", "relations", "books"}},
    ...
    "pdf_set_book_answer_mapping": {"description": "Create or update a book unit to answer-page mapping.", "tags": {"mutation", "groups", "relations", "books"}},
    "pdf_delete_book_answer_mapping": {"description": "Delete the answer-page mapping for a registered book unit file.", "tags": {"mutation", "groups", "relations", "books"}},
