...
![Grammar MCQ section header](./english_exam_question_type_croppings/grammar_mcq_section_header.png)

The printed section title is usually **Section A: Grammar**. In PSLE-style Paper 2, this is usually the first Booklet A section.

#### Sample questions

![Grammar MCQ sample questions](./english_exam_question_type_croppings/grammar_mcq_sample_questions.png)
...
![Vocabulary MCQ section header](./english_exam_question_type_croppings/vocabulary_mcq_section_header.png)
...
![Vocabulary MCQ sample questions](./english_exam_question_type_croppings/vocabulary_mcq_sample_questions.png)
...
![Vocabulary Cloze section header](./english_exam_question_type_croppings/vocabulary_cloze_section_header.png)
...
![Vocabulary Cloze sample questions](./english_exam_question_type_croppings/vocabulary_cloze_sample_questions.png)
...
![Visual Text Comprehension section header](./english_exam_question_type_croppings/visual_text_comprehension_section_header.png)
...
![Visual Text Comprehension Text 1](./english_exam_question_type_croppings/visual_text_comprehension_text1.png)

##### Text 2

![Visual Text Comprehension Text 2](./english_exam_question_type_croppings/visual_text_comprehension_text2.png)

#### Sample questions

![Visual Text Comprehension sample questions](./english_exam_question_type_croppings/visual_text_comprehension_sample_questions.png)
...
![Grammar Cloze section header](./english_exam_question_type_croppings/grammar_cloze_section_header.png)

The printed section title is usually **Section E: Grammar Cloze**. This is the first Booklet B section in this sample.

#### Sample questions

![Grammar Cloze sample questions](./english_exam_question_type_croppings/grammar_cloze_sample_questions.png)
...
![Editing section header](./english_exam_question_type_croppings/editing_section_header.png)

The printed section title is usually **Section F: Editing for Spelling and Grammar**.

#### Sample questions

![Editing sample questions](./english_exam_question_type_croppings/editing_sample_questions.png)
...
![Comprehension Cloze section header](./english_exam_question_type_croppings/comprehension_cloze_section_header.png)
...
![Comprehension Cloze sample questions](./english_exam_question_type_croppings/comprehension_cloze_sample_questions.png)
...
![Synthesis and Transformation section header](./english_exam_question_type_croppings/synthesis_transformation_section_header.png)
...
![Synthesis and Transformation sample questions](./english_exam_question_type_croppings/synthesis_transformation_sample_questions.png)
...
![Comprehension Open-ended section header](./english_exam_question_type_croppings/comprehension_open_ended_section_header.png)
...
![Comprehension Open-ended passage stem](./english_exam_question_type_croppings/comprehension_open_ended_passage_stem.png)

##### Questions

![Comprehension Open-ended sample questions](./english_exam_question_type_croppings/comprehension_open_ended_sample_questions.png)
