# Singapore Primary Science — Exam format & visual structure
...
## PSLE Science (2026 SEAB) — one paper, two booklets, 100 marks

| | **Booklet A** | **Booklet B** |
|---|----------------|----------------|
| **Item type** | Multiple-choice (four options) | Structured (open-ended) |
| **Questions** | **30** | **10–11** |
| **Marks per item** | **2** each | **2, 3, 4 or 5** each (per question) |
| **Section marks** | **60** | **40** |
| **Duration** | **1 hour 45 minutes** (whole paper, both booklets) | |

- Answers for Booklet A are shaded on an **Optical Answer Sheet (OAS)** with **2B pencil** (when issued separately or bundled).
- **Printed diagrams** (experiments, graphs, setups) are integral to many MCQ items.
- Booklet B: **words / phrases / sentences** in spaces; marks in **square brackets** `[n]`; teacher marks and annotations as in other sciences.
