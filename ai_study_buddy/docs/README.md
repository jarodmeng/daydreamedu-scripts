...
| [COMPLETION_MARKING_FRAMEWORK](./L4_COMPLETION_MARKING_FRAMEWORK.md) | Normative model: completion `file_id` vs same basename, one marking run per PDF, `attempt_sequence`, relation to `root_id` / Student File Browser |
