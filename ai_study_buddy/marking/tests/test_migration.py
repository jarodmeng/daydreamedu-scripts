...
def test_backfill_attempt_metadata_dry_run_then_apply(tmp_path):
    ...
    assert payload_first["schema_version"] == "marking_result.v1.6"
    assert payload_second["schema_version"] == "marking_result.v1.6"
...
def test_backfill_is_partial_v1_3_dry_run_then_apply(tmp_path):
    ...
    assert payload_v11["schema_version"] == "marking_result.v1.6"
    assert payload_partial["schema_version"] == "marking_result.v1.6"
    assert payload_full["schema_version"] == "marking_result.v1.6"
